...
async function assetTransfer () {
    ...
    const tx = algosdk.makeAssetTransferTxnWithSuggestedParamsFromObject({
        suggestedParams,
        from: account.addr,
        to: "YHCJOEQE3VND4ELFHZJMTSJWOCNVLQHAWLGYWDDF3YVVOYXPDG54VL62F4", // Receiver Address
        revocationTarget: "G7QDMQ4D4JKH36PF2QIW7IEG2AP6JJ7G6HDJKA2JILLTWTTZC7NUZS2Y6Q", // Revocation Address
